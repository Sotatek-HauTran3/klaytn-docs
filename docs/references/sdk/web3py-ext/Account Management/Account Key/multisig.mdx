...
```
---
Create a Web3 instance with the specified Klaytn **Baobab** testnet URL
...
```
---
In this case, the account key to update is the **mutisig** key and each role has **weight** equal 1.

```py web3_account_update_multisig.py focus=34,38,42

```
---
You can use the **compressed_key** util to set each key. It will extract the compressed public key from the key
