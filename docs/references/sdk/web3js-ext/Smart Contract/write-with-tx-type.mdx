...
```
---
Create a transaction object that increment the **number**, the transaction has params **type: TxType.SmartContractExecution**
```js smartContractWriteWithTxType.js focus=41:47
