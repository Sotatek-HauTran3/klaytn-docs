...
```java TxTypeFeeDelegatedValueTransfer.java focus=24:25
...
```java TxTypeFeeDelegatedValueTransfer.java focus=29

```
---
Get the chain ID from the **Klaytn** network

```java TxTypeFeeDelegatedValueTransfer.java focus=31:32
...
```java TxTypeFeeDelegatedValueTransfer.java focus=35:37

```
---
Create a raw transaction object using above parameters

```java TxTypeFeeDelegatedValueTransfer.java focus=39:56
...
```java TxTypeFeeDelegatedValueTransfer.java focus=48:49
