...
Import necessary classes from the Web3j and Klaytn libraries

```java FeeDelegatedSmartContractDeployExample.java focus=1:17
...
```java FeeDelegatedSmartContractDeployExample.java focus=28

```
---

Create KlayCredentials for sender and fee payer using the private key from the keySample interface


```java FeeDelegatedSmartContractDeployExample.java focus=29:30
...
```java FeeDelegatedSmartContractDeployExample.java focus=34:36
...
```java FeeDelegatedSmartContractDeployExample.java focus=40:46
...
```java FeeDelegatedSmartContractDeployExample.java focus=48:57

```

---

Sign the raw transaction as sender


```java FeeDelegatedSmartContractDeployExample.java focus=59:60
...
```java FeeDelegatedSmartContractDeployExample.java focus=65:67
...
```java FeeDelegatedSmartContractDeployExample.java focus=67:75
...
```java FeeDelegatedSmartContractDeployExample.java focus=76
...
```java FeeDelegatedSmartContractDeployExample.java focus=78:79
