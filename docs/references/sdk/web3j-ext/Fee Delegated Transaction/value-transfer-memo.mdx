...
```java FeeDelegatedValueTransferMemo.java focus=24:25
...
```java FeeDelegatedValueTransferMemo.java focus=29

```
---
Get the chain ID from the **Klaytn** network

```java FeeDelegatedValueTransferMemo.java focus=30

```
---
Initialize variables for transaction parameters

```java FeeDelegatedValueTransferMemo.java focus=31:40
