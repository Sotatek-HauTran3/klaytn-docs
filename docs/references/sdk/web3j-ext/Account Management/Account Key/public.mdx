...
```java AccountUpdateWithPubKeyExample.java focus=28:29
...
```java AccountUpdateWithPubKeyExample.java focus=31:32
...
```java AccountUpdateWithPubKeyExample.java focus=34:35
...
```java AccountUpdateWithPubKeyExample.java focus=36:37

```
---
Generate a new **account key** for account update from created **public key**

```java AccountUpdateWithPubKeyExample.java focus=39:41

```
---
Set transaction type as **ACCOUNT_UPDATE**
```java AccountUpdateWithPubKeyExample.java focus=43
...
```java AccountUpdateWithPubKeyExample.java focus=45:51

```
---
Sign the transaction

```java AccountUpdateWithPubKeyExample.java focus=53

```
---
Send the signed transaction to Klaytn network

```java AccountUpdateWithPubKeyExample.java focus=54:57
...
```java AccountUpdateWithPubKeyExample.java focus=59:68
...
```java AccountUpdateWithPubKeyExample.java focus=69

```
---
Decode the raw transaction to get the transaction type

```java AccountUpdateWithPubKeyExample.java focus=71:73
