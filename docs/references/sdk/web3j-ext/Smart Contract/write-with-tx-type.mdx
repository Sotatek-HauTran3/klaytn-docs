...
```java WriteContractWithKlaytnTxTypeExample.java focus=3:26

```
---
Connect to the Klaytn blockchain using Web3j and specify the URL
```java WriteContractWithKlaytnTxTypeExample.java focus=31

```
---
Create KlayCredentials using the private key
```java WriteContractWithKlaytnTxTypeExample.java focus=32

```
---
Define smart contract address to interact with
```java WriteContractWithKlaytnTxTypeExample.java focus=33

```
---
Define gas price and gas limit for contract transactions
```java WriteContractWithKlaytnTxTypeExample.java focus=34:35

```
---
Define from and get chainId, nonce
```java WriteContractWithKlaytnTxTypeExample.java focus=36:40

```
---
Create a gas provider with static gas price and gas limit
```java WriteContractWithKlaytnTxTypeExample.java focus=42
...
```java WriteContractWithKlaytnTxTypeExample.java focus=46

```
---
Calculate payload by function name and definition
```java WriteContractWithKlaytnTxTypeExample.java focus=48:53

```
---
Increment the number stored in the contract by calling the increment function
```java WriteContractWithKlaytnTxTypeExample.java focus=55:70

```
---
Get the updated number stored in the contract after writing
```java WriteContractWithKlaytnTxTypeExample.java focus=77
