...
```
---
Set gas price, gas limit, sender address, and nonce

```java smartContractDeploy.java focus=31:35
...
```java smartContractDeploy.java focus=42:44

```
---
Set the transaction type to smart contract deployment

```java smartContractDeploy.java focus=44
...
```
---
Get and print the transaction receipt

```java smartContractDeploy.java focus=61:68

```
---
Shutdown the web3 instance
