...
```java txTypeValueTransferTransaction.java focus=31:32

```
---
Get the sender's address from `credentials.getAddress()`

```java txTypeValueTransferTransaction.java focus=33

```
---
Get the chain ID from the **Klaytn** network

```java txTypeValueTransferTransaction.java focus=34

```
---
Initialize variables for transaction parameters

```java txTypeValueTransferTransaction.java focus=35:41

```
---
Create a raw transaction object using above parameters
```java txTypeValueTransferTransaction.java focus=43:50
