...
Import the **ethers** and **@klaytn/ethers-ext** packages to add klaytn features in ethers.js
...
```
---
Declare sender's wallet from private key
...
Declare transaction with the fields such as **type, from, to, value, data**.  
