...
```
---
Create a contract instance with **ethers.Contract**, fill in params **contractAddr**, **abi**, **provider**
...
---
Send the tx to the blockchain by **fee payer's wallet**. Other fields that are not declared are filled automatically in **sendTransaction** function. It will return the tx hash, which will be used to wait the receipt
<CH.Code>
