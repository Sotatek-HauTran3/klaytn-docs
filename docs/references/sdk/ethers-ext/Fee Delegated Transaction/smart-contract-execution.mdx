...
---
Import the **ethers** and **@klaytn/ethers-ext** modules to add Klaytn features on ethers.js.
...
```
---
Create a contract instance using **ethers.Contract** and params **contractAddr**, **abi**, **provider**
...
Sign the transaction by the **sender wallet**
...
---
Send the transaction with **fee payer wallet**. Other fields that are not declared are filled automatically in **sendTransaction** function. It will return the tx hash, which will be used to wait the receipt
<CH.Code>
